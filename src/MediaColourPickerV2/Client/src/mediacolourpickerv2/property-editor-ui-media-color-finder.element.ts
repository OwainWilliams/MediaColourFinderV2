...
export class WscPropertyEditorUIMediaColorFinderElement extends UmbLitElement implements UmbPropertyEditorUiElement {
	...
	public set value(value: MediaColorFinderValue | undefined) {
		this.#value = value;
		this.#lastValue = value;

		if (value) {
			this._average = value.average;
			this._brightest = value.brightest;
			this._opposite = value.opposite;
			this._textColour = value.textColour;
		}
	}
	public get value(): MediaColorFinderValue | undefined {
		return this.#value;
	}
	#value?: MediaColorFinderValue | undefined;
	#lastValue?: MediaColorFinderValue | undefined;
	...
	#calculateColors() {
		...
		if (!jsonStringComparison(this.value, this.#lastValue)) {
